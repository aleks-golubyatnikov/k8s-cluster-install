...
az vm extension set \
  ...
  --resource-group RG-k8s-cluster \
  --settings '{"commandToExecute":"apt-get -y update && apt-get -y install ansible && mkdir -m 0755 /home/init-cluster && git clone https://github.com/aleks-golubyatnikov/k8s-cluster-install.git /home/init-cluster && chmod 0755 -R /home/init-cluster"}'
